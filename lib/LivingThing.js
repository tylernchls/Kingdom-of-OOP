module.exports = class LivingThing {
  constructor(name, uniCellular, trueNucleus, anaerobic, asexual, mobile, multiCellular, prokaryote, aerobic, sexual, immobile){
    this._name = name;
    ...
    this._mobile = mobile;
    this._multiCellular = multiCellular;
    this._prokaryote = prokaryote;
    this._aerobic = aerobic;
    this._sexual = sexual;
    this._immobile = immobile;
  }
